    ...
    mockUseRecentTransactions.mockReturnValue([
      {
        ...
        key: 'register-test-hyphens.fil-0x99b7A9E80F46F7d0eB11b5147e6fF64E47698b6C',
      },
    ])
    render(<TransactionSection />)
    expect(screen.getByText('transaction.description.registerName: test-hyphens.fil')).toBeVisible()
  })
    ...
    mockUseRecentTransactions.mockReturnValue([
      {
        ...
        action: 'registerName',
        hash: '0x4d6cf7e1c8620a59c8a0d2d2c9bf9bbca6dbf65e694f01d1e5f85c87315e20c7',
        key: 'register-test.fil-0x99b7A9E80F46F7d0eB11b5147e6fF64E47698b6C',
      },
    ])
    render(<TransactionSection />)
    expect(screen.getByText('transaction.description.registerName: test.fil')).toBeVisible()
  })
    ...
    mockUseRecentTransactions.mockReturnValue([
      {
        ...
        action: 'commitName',
        hash: '0x4d6cf7e1c8620a59c8a0d2d2c9bf9bbca6dbf65e694f01d1e5f85c87315e20c7',
        key: 'commit-test-hyphens.fil-0x99b7A9E80F46F7d0eB11b5147e6fF64E47698b6C',
      },
    ])
    render(<TransactionSection />)
    expect(screen.getByText('transaction.description.commitName: test-hyphens.fil')).toBeVisible()
  })
    ...
    mockUseRecentTransactions.mockReturnValue([
      {
        ...
        action: 'commitName',
        hash: '0x4d6cf7e1c8620a59c8a0d2d2c9bf9bbca6dbf65e694f01d1e5f85c87315e20c7',
        key: 'commit-test.fil-0x99b7A9E80F46F7d0eB11b5147e6fF64E47698b6C',
      },
    ])
    render(<TransactionSection />)
    expect(screen.getByText('transaction.description.commitName: test.fil')).toBeVisible()
  })
})
