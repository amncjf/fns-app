...
export const useEstimateFullRegistration = ({ paymentMethodChoice, registrationData, price, name }: FullProps) => {
  ...
  const totalYearlyFeeFns = yearlyFeeFns?.mul(registrationData.years)
